...
import com.bergcomputers.mobilebanking.transaction.TransactionDetailFragment;
 ...
 */
public class TransactionDetailActivity extends BaseActivity implements IJSONNetworkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Long curreencyId = getIntent().getLongExtra(TransactionDetailFragment.ARG_ITEM_ID, -1L);
    ...
    public void handleResult(String pJSONString, int currentAction) {
        if (null != pJSONString) {
            ...
            arguments.putString(TransactionDetailFragment.ARG_ITEM_ID, pJSONString);
