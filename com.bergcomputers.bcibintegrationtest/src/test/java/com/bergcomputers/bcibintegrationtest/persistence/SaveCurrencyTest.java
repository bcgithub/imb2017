...
import com.bergcomputers.domain.BaseEntity;
...
public class SaveCurrencyTest {
	...
	private Long id = 7L;
	private String symbol = "RON";
	private Double exchangeRate = 1.0d;

	@Deployment
	public static WebArchive createDeployment() {
		return ShrinkWrap.create(WebArchive.class, "test.war").addPackage(Currency.class.getPackage())
	...
	@Test
	@UsingDataSet("datasets/TwoCurrencies_initial.xml")
	@ShouldMatchDataSet(value = "datasets/TwoCurrencies_save.xml", excludeColumns = { "id", "creationDate",
			"currencyid" })
