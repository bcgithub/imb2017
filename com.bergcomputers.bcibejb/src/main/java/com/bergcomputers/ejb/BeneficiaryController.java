...
public class BeneficiaryController  extends AbstractController<Currency, Long> implements IBeneficiary {
	...
	public BeneficiaryController(Class<Currency> entityClass) {
		super(entityClass);
